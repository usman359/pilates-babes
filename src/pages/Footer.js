  ...
  return (
    <div className="bg-[#a08679] p-8 sm:p-20">
      <div className="grid grid-cols-2 justify-items-center gap-10 p-10 sm:grid-cols-3 sm:gap-24 sm:p-24 lg:grid-cols-4">
        <div>
          <h1 className="mb-4 text-2xl text-[#fecdd3]">Get In Touch</h1>
          <div className="mb-3 flex gap-2 text-lg text-white">
            <span>
        ...
        <div>
          <h1 className="mb-4 text-2xl text-[#fecdd3]">Quick Links</h1>
          <FooterNav />
        </div>

        <div>
          <h1 className="mb-4 text-2xl text-[#fecdd3]">Regular Links</h1>
          <FooterNav />
        </div>

        <div>
          <h1 className="mb-4 text-2xl text-[#fecdd3]">Opening Hours</h1>
          <div className="mb-4 flex flex-col text-lg text-white">
