      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="grid grid-cols-1 gap-12 text-center md:grid-cols-2">
            <div>
              <div className="mb-4 text-6xl text-pink-500">
          ...
          <button className="mt-16 rounded border-2 border-gray-900 bg-transparent px-8 py-4 text-xl font-semibold text-gray-900 transition duration-300 hover:bg-pink-500 hover:text-white lg:text-2xl">
            Learn More
          </button>
        </div>
      </div>
