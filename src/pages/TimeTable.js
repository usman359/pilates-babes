...
export default function TimeTable() {
  return (
    <div
      className="relative mx-auto flex min-h-screen w-3/5 flex-col items-center justify-center overflow-x-auto text-center"
      id="calendar"
    >
      ...
      <table className="w-full border-collapse text-2xl">
        ...
        <tbody>
          <tr>
            ...
            <td className="border border-gray-300 p-4">
              <strong className="block px-2 py-1 font-medium">Crossfit</strong>
              <span className="block px-2 py-1 font-light">Adam Phillips</span>
            </td>
            <td className="border border-gray-300 p-4"></td>
            <td className="border border-gray-300 p-4">
